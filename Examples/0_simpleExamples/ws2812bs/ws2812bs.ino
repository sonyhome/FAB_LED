...
///
/// This example is for an Arduino Uno board with 2 LED strips connected to
/// port D5 and D6. Targetting any other board requires you to change something.
...
/// Wiring:
///
/// The 1st LED strip DI (data input) line should be on port D5 (Digital pin 5 on
/// Arduino Uno).
/// The 2st LED strip DI (data input) line should be on port D6 (Digital pin 6 on
/// Arduino Uno).
